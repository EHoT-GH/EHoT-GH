...
Casino.prototype = {
	...
	play : function(money){
		...
		if((money * 5) > casMoney) {
			...
			var avalible = [];
			this.machines.forEach(function(el){
				avalible.push(el.number + 1);
			});

			var machine = prompt('Enter slot. Availeble slots = ' + avalible, 1);
...
var casino = new Casino(10, 5000);
console.log(casino.machines);
console.log(casino.showCasinoMoney());
console.log(casino.SlotMachines());


// Casino bankroll - casino.showCasinoMoney();
// Create slot machine - casino.create();
// Amount of slot machines - casino.SlotMachines();
// Delete slot machine - casino.deleteMachine(1);
// CashOut from casino - casino.cashOut(50);
// Play - casino.play(50);
// slot machine bankroll - casino.machines[0].showMoney();
// cashOut from slot machine - casino.machines[0].cashOut();
// put money in slot machine - casino.machines[0].putMoney();